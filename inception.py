...
x = GlobalAveragePooling2D()(inception.output)  # Use Global Average Pooling
...
model.save('inceptionv3_crop_disease_detection.h5')
...
plt.savefig('training_validation_accuracy_inception.png')  # Save the plot to a file
...
plt.savefig('training_validation_loss_inception.png')  # Save the plot to a file
